...
*   **服务商全功能增删改查与个性化色彩体系**：除三大官方系统服务商受防误删保护外，用户可自由增删改查任意自定义服务商；内置 13 款高雅调色板与原生 1677 万色彩拾取器，结合亮度算法智能自适应黑/白高对比度文字。
*   **多维检索与分类药丸**：支持按服务商名、端点协议、Base URL 及所包含模型多维模糊搜索，并配备「全部 / 已配置 / 自定义」分类药丸筛选器。
...
*   **工业级混合模式 (Tag + NL · 推荐首选)**：上段输出 20~40+ 细粒度 Danbooru 概念解构短标签，下段输出高信息密度自然语言美学段落，严格空行隔离，彻底防止 LoRA 概念污染并粘合微观材质光影。
...
### 10. 📝 实时运行日志与诊断中心 (Realtime Log Center)
*   **全链路透明化监控**：内置无依赖内存日志追踪器，实时捕获网络请求状态、429 速率限制倒计时、接口响应耗时与单图重试轨迹。
*   **保姆级跨域排查引导**：精准侦测第三方端点 CORS 跨域限制与鉴权异常，提供桌面级与本地代理针对性排障解决方案。
